...
public class MethodeDeclaration implements Declaration, Instruction {
	protected Signature entete;
	
	protected ElementNature state; //final, static
	...
	public MethodeDeclaration(ElementNature _state, Signature _signature, Block _corps) {
		this.state = _state;
